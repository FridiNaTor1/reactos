...
#if 0
    ok_eq_hex64(pContext->Dr0, 0xCCCCCCCC);
    ok_eq_hex64(pContext->Dr1, 0xCCCCCCCC);
    ok_eq_hex64(pContext->Dr2, 0xCCCCCCCC);
    ok_eq_hex64(pContext->Dr3, 0xCCCCCCCC);
    ok_eq_hex64(pContext->Dr6, 0xCCCCCCCC);
    ok_eq_hex64(pContext->Dr7, 0xCCCCCCCC);
#endif
    ok_eq_hex64(pContext->Rax, continueContext.Rax);
    //ok_eq_hex64(pContext->Rcx, continueContext.Rsp);
